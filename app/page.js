...
{/* 3rd */}
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div class="mx-auto flex max-w-xs flex-col gap-y-4">
        ...
        <h1 class="order-first text-3xl font-semibold tracking-tight text-mypurple sm:text-5xl">410+</h1>
      </div>
      <div class="mx-auto flex max-w-xs flex-col gap-y-4">
        <dt class="text-base leading-7 text-grey-300">Projects Completed</dt>
        <dd class="order-first text-3xl font-semibold tracking-tight text-mypurple sm:text-5xl">889+</dd>
      </div>
      <div class="mx-auto flex max-w-xs flex-col gap-y-4">
      ...
      <div class="w-auto p-8">
        <a href="#">
          <div class="inline-flex items-center">
            ...
            <span class="hidden md:block h-[70px] w-[70px]"><img src="./logo.png" alt="" /></span>
          </div>
        </a>
      </div>
      <div class="w-auto p-8">
